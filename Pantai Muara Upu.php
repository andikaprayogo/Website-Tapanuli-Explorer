...
<body>
    ...
    <div class="header-image">
        <img src="Pantai Muara Upu.jpg" alt="Pantai Muara Upu">
        <div class="header-text">
            <h1>Pantai Muara Upu</h1>
            <p><a href="tapsel.php" style="color: white;">Tapsel</a> >> Pantai Muara Upu</p>
        </div>
    </div>
    ...
    <h1>Pantai Muara Upu</h1>
        ...
        <div class="about-us-container">
            <div id="photosContent" style="display: none;">
              ...
              <img src="Pantai Muara Upu.jpg" width="450" height="400" alt="Photo 1">
              <img src="Pantai Muara Upu 1.jpg" width="450" height="400" alt="Photo 2">
              <!-- Tambahkan foto-foto wisata sesuai kebutuhan -->
            </div>
          
            <div id="mapsContent" style="display: none;">
              <h1>Lokasi Pantai Muara Upu</h1>
              <!-- Konten peta -->
              <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3988.741305374311!2d98.84423842215665!3d1.3313177115470627!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x302eb7e7f2244b5d%3A0x578808e60783854b!2sMuara%20Opu%2C%20Muara%20Batangtoru%2C%20Tapanuli%20Selatan!5e0!3m2!1sid!2sid!4v1701263736447!5m2!1sid!2sid" width="450" height="400" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                  </div>
              </div>
          </div>
...
<!-- JavaScript Kustom -->
<script src="Pantai Muara Upu.js"></script>
